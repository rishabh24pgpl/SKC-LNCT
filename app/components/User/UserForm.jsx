"use client";
import { USER_INITIAL, userTypes } from "@/app/lib/constants";
import React, { useEffect, useState } from "react";
import UserTypesDropDown from "../Dropdown/UserTypesDropDown";
import { addUser, updateUser } from "@/app/lib/services/user/userServices";
...
import { validateInputs } from "@/app/lib/helpers/isValidInput";
import useDropdown from "@/app/components/hooks/useDropDown";

const UserForm = ({ roles = [], schoolUuid, schools }) => {
 console.log(schools,'hhhhhhhh')
