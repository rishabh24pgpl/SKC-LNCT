...
function Lamp({ heading, content }) {
  return (
    <LampContainer>
      ...
      >
        {heading}
        <br /> <p className=" text-center mt-10 mx-auto text-base">{content}</p>
      </motion.h1>
    </LampContainer>
  );
}
...
const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        "relative flex h-[650px] flex-col items-center  justify-center overflow-hidden bg-slate-950 w-full  z-0",
        className
      )}
    >
