                    ...
                    <nav className="nav flex-col lg:w-1/4 p-4">
                        ...
                        <ul className="space-y-2 bg-white rounded-xl p-4">
                            <li className="p-4 bg-white rounded-lg text-black hover:bg-orange-400">
                                <button
                                    onMouseEnter={() => handleTabClick("undergraduate")}
                                    className={`nav-link ${activeTab === "undergraduate" ? "active" : ""
                                        }`}
                                    role="tab"
                                >
                                    UNDERGRADUATE
                            ...
                            <li className="p-4 bg-white rounded-lg text-black hover:bg-orange-400">
                                <button
                                    onMouseEnter={() => handleTabClick("postgraduate")}
                                    className={`nav-link ${activeTab === "postgraduate" ? "active" : ""
                                        }`}
                                    role="tab"
                                >
                                    POSTGRADUATE
                            ...
                            <li className="p-4 bg-white rounded-lg text-black hover:bg-orange-400">
                                <button
                                    onMouseEnter={() => handleTabClick("doctoral")}
                                    className={`nav-link ${activeTab === "doctoral" ? "active" : ""
                                        }`}
                                    role="tab"
                                >
                                    DOCTORAL
                            ...
                            <li className="p-4 bg-white rounded-lg text-black hover:bg-orange-400">
                                <button
                                    onMouseEnter={() => handleTabClick("executive")}
                            ...
                            <li className="p-4 bg-white rounded-lg text-black hover:bg-orange-400">
                                <button
                                    onMouseEnter={() => handleTabClick("parttime")}
